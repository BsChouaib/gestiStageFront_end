...
@Component({
  ...
  standalone: true,
  imports: [SharedModule, MatTableModule, MatPaginator, MatMenuModule, MatIconModule, MatButtonModule, MatDialogModule, RouterModule, MatTooltipModule],
...
export default class DemandComponent implements AfterViewInit, OnInit, OnDestroy {
