...
@Component({
  ...
  styleUrls: ['./add-internship-dialog.component.sass'],
  standalone: true,
...
export class AddInternshipDialogComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AddInternshipDialogComponent>,
